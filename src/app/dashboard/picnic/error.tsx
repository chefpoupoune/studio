...
import { ShoppingBasket } from "lucide-react"; // Using a relevant icon

export default function PicnicErrorPage({
  error,
  reset,
}: {
  ...
  return (
    <div className="container mx-auto flex min-h-[calc(100vh-10rem)] flex-col items-center justify-center space-y-6 p-4 text-center">
      ...
      <h1 className="text-3xl font-bold text-destructive">
        Une erreur est survenue dans la section Pique Nique.
      </h1>
