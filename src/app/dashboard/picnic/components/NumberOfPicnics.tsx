...
export default function NumberOfPicnics() {
  return (
    <Card className="shadow-lg">
      <CardHeader>
        <CardTitle>Nombre de Pique-Niques (NB PN)</CardTitle>
        <CardDescription>
          Fonctionnalité pour gérer le nombre de pique-niques prévus.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex flex-col items-center justify-center text-center p-10 border-2 border-dashed border-muted-foreground/20 rounded-lg bg-card/50 min-h-[200px]">
          ...
          <p className="text-sm text-muted-foreground/80 mt-2">
            Ici, vous pourrez saisir le nombre de pique-niques pour différentes dates ou périodes.
          </p>
        </div>
      </CardContent>
    </Card>
