...
import { ArchiveX } from "lucide-react"; // Icon for inventory error

export default function InventoryErrorPage({
  error,
  reset,
}: {
  ...
  return (
    <div className="container mx-auto flex min-h-[calc(100vh-10rem)] flex-col items-center justify-center space-y-6 p-4 text-center">
      ...
      <h1 className="text-3xl font-bold text-destructive">
        Une erreur est survenue dans la section Gestion des Stocks.
      </h1>
      <p className="text-lg text-muted-foreground">
        Nous sommes désolés, quelque chose s&apos;est mal passé avec la gestion des stocks. Vous pouvez essayer de recharger la page ou de revenir au tableau de bord.
      </p>
